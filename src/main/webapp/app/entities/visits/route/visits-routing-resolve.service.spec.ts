...
describe('Visits routing resolve service', () => {
  ...
  let resultVisits: IVisits | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IVisits if id is not provided', () => {
      // GIVEN
      ...
      expect(resultVisits).toEqual(new Visits());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Visits })));
      mockActivatedRouteSnapshot.params = { id: 123 };
