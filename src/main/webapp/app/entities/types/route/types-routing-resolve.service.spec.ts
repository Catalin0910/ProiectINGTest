...
describe('Types routing resolve service', () => {
  ...
  let resultTypes: ITypes | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ITypes if id is not provided', () => {
      // GIVEN
      ...
      expect(resultTypes).toEqual(new Types());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Types })));
      mockActivatedRouteSnapshot.params = { id: 123 };
