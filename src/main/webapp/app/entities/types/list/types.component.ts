...
export class TypesComponent implements OnInit {
  ...
  trackId(_index: number, item: ITypes): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ITypes[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
